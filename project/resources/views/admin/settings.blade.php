                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="payment">
                                    ...
                                    <form method="POST" action="settings/payment" class="form-horizontal form-label-left" id="website_form">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="title"> Shipping Cost(USD) <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="shipping_cost"  pattern="[0-9]+(\.[0-9]{0,2})?%?"
                                                       title="Shipping Cost must be numeric or up to 2 decimal places." placeholder="Shipping Cost" required="required" type="text" value="{{$setting[0]->shipping_cost}}">
                                            </div>
                                        </div>
